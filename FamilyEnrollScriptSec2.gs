...
* - 'SNS/04/' Center code in Family Id
...
function newFamilyEnrollment(itemResponses)
{
  ...
  var memberRowObject = {
    'Head': [newserialDigit,familyID,'ACTIVE','Head of Family',record_array.Head_Name,formatDate(record_array.Head_DOB),'','',record_array.Present_Address,record_array.Contact_Number, record_array.Head_Aadhar,'',record_array.Head_Qualification,record_array.Head_Occupation],
