...
function newFamilyEnrollment(itemResponses)
{
  ...
  var familyMemberRowObject = {
    'Head': [nextFamilySerial,familyID,'Head of Family',formDataArr.Head_Name,'',formatDate(formDataArr.Head_DOB),'',formDataArr.Present_Address,formDataArr.Contact_Number, formDataArr.Head_Aadhar,'',formDataArr.Head_Qualification,formDataArr.Head_Occupation],
